    ...
    <section className="py-24 relative">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <AnimatedSection className="flex justify-center mb-8">
          <SectionLabel label="Client Testimonial" className="justify-center" />
        </AnimatedSection>

        <AnimatedSection delay={0.2}>
          <div className="max-w-4xl mx-auto p-8 md:p-12 rounded-2xl bg-black/55 backdrop-blur-[2px] border border-white/10 ring-1 ring-white/10 text-center relative">
